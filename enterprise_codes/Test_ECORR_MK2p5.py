...
############## Data files and par files are taken from the MeerKAT 2p5 yr data ########################3
datadir = os.path.abspath("/fred/oz002/users/mmiles/MPTA_GW/partim/"+str(dir))
pfile = os.path.join("/fred/oz002/users/mmiles/MPTA_GW/partim/",psrname+".par")  ### When using MeerKAT data
